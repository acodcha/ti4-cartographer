...
public:
  ...
  ) noexcept : Board(board_layout) {
    run(board_aggression, number_of_iterations, selected_system_ids);
  }

protected:

  void initialize_tiles() noexcept override {
  ...
  void initialize_player_pathways_to_mecatol_rex() noexcept override {
  ...
  void initialize_player_forward_positions() noexcept override {
  ...
  void initialize_player_lateral_starboard_positions() noexcept override {
  ...
  void initialize_player_lateral_port_positions() noexcept override {
