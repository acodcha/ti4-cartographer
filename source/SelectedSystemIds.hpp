...
// TODO: Deprecate this class once ready.
class OldSelectedSystemIds {

public:

  OldSelectedSystemIds() noexcept {}

  OldSelectedSystemIds(const GameVersion game_version, const Layout layout) noexcept {
